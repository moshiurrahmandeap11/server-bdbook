...
router.post("/friend-request/accept/:requestId", auth(), friendController.acceptFriendRequest);
router.post("/friend-request/decline/:requestId", auth(), friendController.declineFriendRequest);
