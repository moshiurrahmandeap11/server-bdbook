...
const createPost = catchAsync(async (req, res) => {
    const result = await postService.createPost(req.user.id, req.body.description, req.file);
    sendResponse(res, {
...
const deleteComment = catchAsync(async (req, res) => {
    const { postId, commentId } = req.params;
    await postService.deleteComment(req.user.id, req.user.role, postId, commentId);
    sendResponse(res, {
        httpStatusCode: status.OK,
        success: true,
...
const getReposts = catchAsync(async (req, res) => {
    const { postId } = req.params;
...
const markInterested = catchAsync(async (req, res) => {
    const { postId } = req.params;
...
const updatePost = catchAsync(async (req, res) => {
    const { postId } = req.params;
    const result = await postService.updatePost(req.user.id, req.user.role, postId, req.body.description);
    sendResponse(res, {
        httpStatusCode: status.OK,
        success: true,
