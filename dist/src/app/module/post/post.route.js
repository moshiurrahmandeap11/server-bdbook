...
const router = Router();
router.post("/create", auth(), postUpload.single("media"), postController.createPost);
...
router.post("/:postId/comment", auth(), validateRequest(postValidation.commentValidationSchema), postController.addComment);
router.patch("/:postId/comment/:commentId", auth(), postController.editComment);
...
router.patch("/:postId", auth(), validateRequest(postValidation.editPostValidationSchema), postController.updatePost);
